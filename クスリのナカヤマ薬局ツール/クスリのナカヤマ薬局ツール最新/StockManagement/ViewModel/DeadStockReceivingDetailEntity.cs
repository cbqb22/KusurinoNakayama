...
{
    public class DeadStockReceivingDetailEntity
    {
        private int _no;
    ...
    public class DeadStockReceivingDetailEntityComparer : IEqualityComparer<DeadStockReceivingDetailEntity>
    {
        // Products are equal if their names and product numbers are equal.
        public bool Equals(DeadStockReceivingDetailEntity x, DeadStockReceivingDetailEntity y)
        {
        ...
        public int GetHashCode(DeadStockReceivingDetailEntity ent)
        {
