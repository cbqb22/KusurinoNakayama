...
{
    public class DeadStockAllStoreNoUseEntity
    {
    ...
    public class DeadStockAllStoreNoUseEntityComparer : IEqualityComparer<DeadStockAllStoreNoUseEntity>
    {
        // Products are equal if their names and product numbers are equal.
        public bool Equals(DeadStockAllStoreNoUseEntity x, DeadStockAllStoreNoUseEntity y)
        {
        ...
        public int GetHashCode(DeadStockAllStoreNoUseEntity ent)
        {
